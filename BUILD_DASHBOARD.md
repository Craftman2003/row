...
A single `<h1 class="dash-title">Kristjáns Höfuðstöðvar</h1>` at the very top of the body. Styled as:
...
- The page opens with a gradient `Kristjáns Höfuðstöðvar` headline at the top.
